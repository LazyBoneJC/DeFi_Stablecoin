...
contract DSCEngineTest is Test {
    ...
    function testCanRedeemCollateral() public depositedAndMinted {
        ...
        assertEq(ERC20Mock(weth).balanceOf(USER), expectedWethBalance);
    }
    ...
    function testCanBeLiquidated() public setupLiquidation {
        ...
        assertEq(ERC20Mock(weth).balanceOf(LIQUIDATOR), liquidatorInitialWethBalance + expectedCollateralForLiquidator);
    }
